import datetime
from control_tk2000 import control_tk
from app.repositories.in_memory_experiment import InMemoryExperiment

def check_for_interval_change(current_temperature):

    current_time = datetime.datetime.now().timestamp()

    temperature_interval_change = round((InMemoryExperiment.final_temperature - InMemoryExperiment.initial_temperature)/InMemoryExperiment.interval,1)
